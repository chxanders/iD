...
GRANT SELECT ON import_status TO "lighttpd" ;
...
GRANT SELECT ON query_log TO "lighttpd" ;
GRANT INSERT ON query_log TO "lighttpd" ;
GRANT UPDATE ON query_log TO "lighttpd" ;
...
GRANT INSERT ON new_query_log TO "lighttpd" ;
GRANT UPDATE ON new_query_log TO "lighttpd" ;
GRANT SELECT ON new_query_log TO "lighttpd" ;
...
GRANT INSERT ON report_log TO "lighttpd" ;
...
GRANT SELECT ON word TO "lighttpd" ;
...
GRANT SELECT ON location_property_aux TO "lighttpd";
...
GRANT SELECT ON location_property_tiger TO "lighttpd";
...
GRANT SELECT on place_boundingbox to "lighttpd" ;
GRANT INSERT on place_boundingbox to "lighttpd" ;
...
GRANT SELECT on reverse_cache to "lighttpd" ;
GRANT INSERT on reverse_cache to "lighttpd" ;
...
GRANT SELECT on placex to "lighttpd" ;
GRANT UPDATE ON placex to "lighttpd" ;
GRANT SELECT ON search_name to "lighttpd" ;
GRANT DELETE on search_name to "lighttpd" ;
GRANT INSERT on search_name to "lighttpd" ;
GRANT SELECT on place_addressline to "lighttpd" ;
GRANT INSERT ON place_addressline to "lighttpd" ;
GRANT DELETE on place_addressline to "lighttpd" ;
GRANT SELECT ON seq_word to "lighttpd" ;
GRANT UPDATE ON seq_word to "lighttpd" ;
GRANT INSERT ON word to "lighttpd" ;
GRANT SELECT ON planet_osm_ways to "lighttpd" ;
GRANT SELECT ON planet_osm_rels to "lighttpd" ;
GRANT SELECT on location_area to "lighttpd" ;
GRANT SELECT on country to "lighttpd" ;
...
GRANT SELECT ON import_polygon_error TO "lighttpd";
